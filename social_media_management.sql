...
BEGIN
 DBMS_OUTPUT.PUT_LINE(SEARCH(102001));
 END;
/
...
-- TYPE IS, NESTED JOIN AND NESTED SQL
...
OPEN POST_CURSOR;
  LOOP
    ...
    EXIT WHEN POST_CURSOR%ROWCOUNT > 6;      
    DBMS_OUTPUT.PUT_LINE(POST_DATA);
  END LOOP; 
CLOSE POST_CURSOR;
